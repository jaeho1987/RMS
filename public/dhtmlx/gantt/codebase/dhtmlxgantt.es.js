...
const ia = (t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1748069103000 > "u")) {
      var e, i;
      setInterval(() => {
        Date.now() - 1748069103000 > 5184e6 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
...
`);
    if (typeof 1748069103000 > "u") return;
    const e = function() {
      var i, a;
      setTimeout(() => {
        Date.now() - 1748069103000 > 7776e6 && window.alert(n), e();
...
Q.gantt = Ur, Q.Gantt = Be, Be.plugin((t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1748069103000 > "u")) {
      var e, i;
      setInterval(() => {
        Date.now() - 1748069103000 > 27648e5 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
