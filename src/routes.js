...
//////////////////////아키텍처 START
const RequirementsDefinition = React.lazy(() => import('./views/requirements/RequirementsDefinition'))
const RequirementsTracking = React.lazy(() => import('./views/requirements/RequirementsTracking'))
//////////////////////아기텍처 종료
//////////////////////시스템관리 START
const CompanyManagement = React.lazy(() => import('./views/system/CompanyManagement'))
...
//////////////////////coreUI END
const routes = [
  { path: '/requirements/definition', name: '요구사항정의', element: <RequirementsDefinition />, private: true },
  { path: '/requirements/tracking', name: '요구사항추적', element: <RequirementsTracking />, private: true },
  { path: '/system/company', name: '회사관리', element: <CompanyManagement />, private: true },
